  ...
  return (
    <section className="wrapper">
      ...
      <div className="image_1 rounded-4xl overflow-hidden">
        <Image width={250} height={350} alt="gallery image" src="/assets/images/workshop_2.jpg" className="w-full h-full object-cover" loading="eager" />
      </div>

      <div className="image_2 rounded-4xl overflow-hidden">
        <Image width={250} height={350} alt="gallery image" src="/assets/images/workshop_1.jpg" className="w-full h-full object-cover" loading="eager" />
      </div>
