    ...
    <section className="grid col-(--content-col) grid-cols-subgrid my-20">
      <div className="grid grid-cols-2 grid-rows-[400px_250px_250px] md:grid-rows-[300px_200px_200px] md:grid-cols-5 gap-3">
        <div className="col-span-2 row-1 md:col-span-3 md:col-start-1 md:row-start-1 md:row-span-1 h-full">
          <ImageOverlay width="2000" height="4000" text="årlig forestilling" image="bilde_1.jpg" variant="six" containerH="h-full" />
        </div>
        <div className="rounded-4xl overflow-hidden row-2 md:row-start-1 md:row-span-2 md:col-start-4 md:col-span-2">
          <Image width={200} height={200} alt="gallery image" src="/assets/images/bilde_1.jpg" className="w-full h-full object-cover" />
        </div>
        <div className="rounded-4xl overflow-hidden row-3 md:row-start-2 md:row-span-2 md:col-start-1 md:col-span-1">
          <Image width={200} height={200} alt="gallery image" src="/assets/images/bilde_1.jpg" className="w-full h-full object-cover" />
        </div>
        <div className="rounded-4xl overflow-hidden row-start-2 row-span-2  md:row-start-2 md:row-span-2 md:col-start-2 md:col-span-2">
          <Image width={200} height={200} alt="gallery image" src="/assets/images/bilde_1.jpg" className="w-full h-full object-cover" />
        </div>
